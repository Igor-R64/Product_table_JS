...
const searchbutton = () => `<button data-action="search" class="btn btn-success ms-3" style="width: 100px;"> Search </button>`;
const addbutton = () => `<button data-action="add" class="btn btn-warning ms-3" style="width: 100px;"> Add New </button>`;
